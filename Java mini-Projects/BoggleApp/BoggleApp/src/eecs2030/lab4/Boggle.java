...
public class Boggle {
	...
	public final static int NUMBER_OF_DICE = LETTERS.length;
	...
	public List<Die> getDice() {
		List<Die> newDie = new ArrayList<>();
		for (Die die : dice) {
			newDie.add(new Die (die));
		}
		return newDie;
	}
