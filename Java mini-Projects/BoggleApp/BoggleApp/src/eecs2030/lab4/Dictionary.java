...
public class Dictionary {
	...
	public boolean lookUp(String word) {
		...
		return this.words.contains(anyWord);
	}
...
//		String anyPrefix = prefix.toLowerCase();
//		SortedSet<String> coolWords = new TreeSet<>();
//		
//		for (String word : words) {
//			if (word.startsWith(anyPrefix)) {
//				coolWords.add(word);
//			}
//		}
//		
...
//	}
		...
		return this.words.subSet(prefix, prefix + "z" );
	}
